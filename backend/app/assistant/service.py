...
CONFIG_SYSTEM = (
    "You are the portfolio configuration engine for PortfolioU, a convex mean-variance "
...
EXPLAIN_SYSTEM = (
    "You are a portfolio education assistant for PortfolioU. Given an optimization result, "
